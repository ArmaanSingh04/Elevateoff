    ...
    <>
      <section className="w-full h-screen flex flex-col">
        <div className="flex w-full p-5 justify-between border-b-2 border-b-gray-500">
          <div className="text-3xl font-bold text-blue-500 cursor-pointer" onClick={() => router.push("/")}>Elevate off</div>
          <div>
            <Button onClick={() => signIn()} variant="default" size="lg" className="bg-blue-500 text-white hover:bg-blue-600 mx-2 text-base">Login</Button>
            <Button onClick={() => router.push('/register')} variant="default" size="lg" className="bg-orange-500 hover:bg-orange-600 text-base">Join now</Button>
          </div>
        </div>
        <div className="flex flex-grow">
          ...
          <div className="right flex flex-col w-full gap-4 justify-center items-center bg-green-100">
            ...
            <p className="text-2xl">Find projects with<b> now</b></p>
